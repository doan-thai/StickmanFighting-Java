...
public final class WoodenSkin {
    ...
    public static Skin create() {
        ...
        BitmapFont font = createUIFont(31,
                ...
                new String[] { "C:/Windows/Fonts/seguisb.ttf", "C:/Windows/Fonts/segoeui.ttf",
                        "C:/Windows/Fonts/arial.ttf" });
        ...
        primaryStyle.over = createRoundedColorDrawable(goldColor.cpy().mul(1.08f), primaryBorder.cpy().mul(0.95f), 320,
                75, 36);
        ...
        successStyle.over = createRoundedColorDrawable(redOrange.cpy().mul(1.08f), successBorder.cpy().mul(0.95f), 220,
                56, 28);
        ...
        lightStyle.over = createRoundedColorDrawable(goldenBrown.cpy().mul(1.08f), lightBorder.cpy().mul(0.95f), 220,
                56, 28);
        ...
        BitmapFont menuTitleFont = createUIFont(74,
                new String[] { "fonts/NotoSans-Regular.ttf", "fonts/DejaVuSans.ttf" },
                new String[] { "C:/Windows/Fonts/georgiab.ttf", "C:/Windows/Fonts/cambriaz.ttf",
    ...
    private static TextureRegionDrawable createRoundedColorDrawable(Color fill, Color border, int width, int height,
            int radius) {
